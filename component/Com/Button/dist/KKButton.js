...
var KKButton_module_scss_1 = require("src/component/Util/KKButton/KKButton.module.scss");
...
function KKButton(_a) {
    var value = _a.value, _b = _a.className, className = _b === void 0 ? '' : _b, item = _a.item, _c = _a.onClick, onClick = _c === void 0 ? function () { } : _c;
    addOnClickEvent();
    var el = react_1["default"].createElement("button", { className: className + ' ' + KKButton_module_scss_1["default"].button, onClick: onClick, "data-item": item }, value);
    return el;
}
